...
comments = {
	...
	'suggestions': "I had to add an async keyword in the provided showReturnIntegerValue function.",
	...
	# None).
	'comments': "Great assignment to wrap up the year. Like a cherry on top. Thank you!",
}
