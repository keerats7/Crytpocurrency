...
comments = {
	...
	'suggestions': 'Units conversion was annoying; bug with estimate_gas? the exact example for estimate_gas from the api docs didnt work; wish there were more test cases',
	...
	# None).
	'comments': 'I like the real-world application of this assignment',
}
